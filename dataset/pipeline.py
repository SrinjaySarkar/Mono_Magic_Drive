...
from .nuscenes_dataset import one_hot_decode
# exit()
...
class LoadBEVSegmentationM:
    ...
    def _get_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # print("here")
        # print("ob cls:",self.object_classes)
        # exit()
        ...
        if self.object_classes is not None:
            ...
            # print("sjdnsadjnadskadasdidiaubdniabd")
            data["gt_masks_bev_static"] = labels
            data["gt_masks_bev"] = labels
        
        # print("object classes in loadbevseg:",self.object_classes)
        # print("classes in loadbevseg:",self.classes)
        
        # for key,_ in data.items():
        # print(data.keys())
        # # 'gt_masks_bev_static', 'gt_masks_bev', 'gt_aux_bev'
        # print(self.classes)
        # print(self.object_classes)
        # print("loadBEVSEG gt masks bev static:",data['gt_masks_bev_static'].shape)
        # print("loadBEVSEG gt masks bev:",data['gt_masks_bev'].shape)
        # print("loadBEVSEG gt aux bev:",data['gt_aux_bev'].shape)
