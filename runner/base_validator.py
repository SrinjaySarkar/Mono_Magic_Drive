...
from misc.img_utils import (img_m11_to_01,concat_6_views,)#visualize_map)
from misc.common import move_to
from misc.test_utils import show_box_on_views,draw_box_on_imgs
from dataset.utils import collate_fn
from model.unet_addon_rawbox import BEVControlNetModel
from runner.map_visualizer import visualize_map
...
class BaseValidator:
    ...
    def validate(
        self,
        controlnet: None, #BEVControlNetModel,
        unet,
